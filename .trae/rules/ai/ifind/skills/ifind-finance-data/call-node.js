...
function resolveAuthToken() {
    const token = process.env.IFIND_AUTH_TOKEN || CONFIG.IFIND_AUTH_TOKEN;
    if (token && !token.startsWith('${connector.')) {
        return token;
    }

    throw new Error('Missing IFIND_AUTH_TOKEN or valid mcp_config.json IFIND_AUTH_TOKEN');
}
