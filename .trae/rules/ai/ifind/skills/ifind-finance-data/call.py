...
def _resolve_auth_token():
    token = os.getenv("IFIND_AUTH_TOKEN") or CONFIG.get("IFIND_AUTH_TOKEN")
    if token and not token.startswith("${connector."):
        return token

    raise RuntimeError("Missing IFIND_AUTH_TOKEN or valid mcp_config.json IFIND_AUTH_TOKEN")
