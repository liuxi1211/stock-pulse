...
3. Execute report assembly workflow using built-in skills:
...
**Key Principles**:
- Use DOCX and XLSX skills (NOT Python libraries)
...
**DELIVER ONLY THIS 1 DOCX FILE. NO executive summaries, no "highlights" documents, no extra files.**
