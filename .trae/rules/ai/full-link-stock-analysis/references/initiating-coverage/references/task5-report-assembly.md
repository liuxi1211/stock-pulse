...
**Prerequisites**: Verify before starting - ALL PREVIOUS TASKS REQUIRED
...
**CRITICAL PRINCIPLE 2**: Use TRAE Work办公's DOCX and XLSX skills to programmatically create the report.

**REQUIRED TOOLS** (TRAE Work办公 has built-in skills for these):
...
**DO**: Use TRAE Work办公's DOCX and XLSX skills to open files, extract data, and create the DOCX report
...
Use TRAE Work办公's file operations to check:
...
**Open and inspect files using TRAE Work办公 skills:**
...
**Use TRAE Work办公's XLSX skill to extract data from Excel files:**
...
Use TRAE Work办公's DOCX skill to:
...
Use TRAE Work办公's DOCX and XLSX skills to:
...
**Throughout the entire assembly process, use TRAE Work办公's DOCX and XLSX skills with actual file operations:**
...
**Do NOT manually copy/paste. Use TRAE Work办公's built-in skills to:**
...
**MOST COMMON MISTAKE: TAKING SHORTCUTS DUE TO LENGTH**
