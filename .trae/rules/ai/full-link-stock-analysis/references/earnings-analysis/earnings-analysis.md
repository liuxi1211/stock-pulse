...
Create 8-12 page DOCX report with specific structure, using the agent's built-in DOCX skill.
...
**Primary Deliverable**: DOCX report (8-12 pages), created via the agent's built-in DOCX skill
