...
&gt; **面向 AI**：本文档收录 Tushare Pro 官方各类接口的权限要求与更新时间，作为对接新接口时的参考依据。
&gt; **与 03 的区别**：
&gt; - [03-tushare-interface-summary.md](./03-tushare-interface-summary.md) → **本项目已对接**的 25 个接口（带实现状态、分组、元数据）
&gt; - 本文档 → Tushare 官方**所有可用**接口大全（带积分权限、更新频率），用于选型参考
...
| 数据名称 | API | 描述 | 最低分值 | 本项目是否对接 |
|---------|-----|------|---------|-------------|
| [日线数据](https://tushare.pro/document/2?doc_id=27) | daily | 全部历史，交易日每日15点～17点之间更新 | 120起 | ✅（daily_quote） |
...
| [复权行情](https://tushare.pro/document/2?doc_id=146) | pro_bar | 全部历史，每月更新 | 2000 （分钟、指数、基金、期货除外） | ❌（用 adj_factor 替代） |
| [每日指标数据](https://tushare.pro/document/2?doc_id=32) | daily_basic | 交易日每日15点～17点之间更新 | 2000起 | ✅（daily_basic） |
| [复权因子](https://tushare.pro/document/2?doc_id=28) | adj_factor | 全部历史，交易日每日更新 | 120起 | ✅（adj_factor） |
| [IPO新股列表](https://tushare.pro/document/2?doc_id=123) | new_share | 每日19点更新 | 120 | ❌ |
| [龙虎榜每日明细](https://tushare.pro/document/2?doc_id=106) | top_list | 数据开始于2005年，每日晚8点更新 | 2000 | ✅（top_list） |
| [龙虎榜机构交易明细](https://tushare.pro/document/2?doc_id=107) | top_inst | 数据开始于2005年，每日晚8点更新 | 2000 | ✅（top_inst） |
...
| [融资融券交易汇总](https://tushare.pro/document/2?doc_id=58) | margin | 数据开始于2010年，每日9点更新 | 2000 | ✅（margin） |
| [融资融交易明细](https://tushare.pro/document/2?doc_id=59) | margin_detail | 数据开始于2010年，每日9点更新 | 2000 | ✅（margin_detail） |
...
| [大宗交易](https://tushare.pro/document/2?doc_id=161) | block_trade | 每日晚9点 | 2000 | ✅（block_trade） |
| [股东人数](https://tushare.pro/document/2?doc_id=166) | stk_holdernumber | 不定期更新 | 2000 | ❌ |
| [个股资金流向](https://tushare.pro/document/2?doc_id=170) | moneyflow | 交易日19点 | 2000 | ✅（moneyflow） |
| [股东增减持](https://tushare.pro/document/2?doc_id=175) | stk_holdertrade | 交易日19点 | 2000 | ❌ |
| [每日涨跌停价格](https://tushare.pro/document/2?doc_id=183) | stk_limit | 交易日9点 | 2000起 | ✅（stk_limit） |
| [沪深股通持股明细](https://tushare.pro/document/2?doc_id=188) | hk_hold | 下个交易日8点 | 2000起 | ✅（hk_hold） |
| [股票基础信息](https://tushare.pro/document/2?doc_id=25) | stock_basic | 每日更新 | 120 | ✅（stock_basic） |
| [股票名称变更](https://tushare.pro/document/2?doc_id=108) | namechange | 每日更新 | 2000 | ✅（namechange） |
| [停复牌信息](https://tushare.pro/document/2?doc_id=212) | suspend_d | 每日更新 | 2000 | ✅（suspend_d） |
...
| 数据名称 | API | 描述 | 最低分值 | 本项目是否对接 |
|---------|-----|------|---------|-------------|
| [利润表](https://tushare.pro/document/2?doc_id=33) | income | 全部历史，实时更新 | 2000起 | ✅（income） |
| [资产负债表](https://tushare.pro/document/2?doc_id=36) | balancesheet | 全部历史，实时更新 | 2000起 | ✅（balancesheet） |
| [现金流量表](https://tushare.pro/document/2?doc_id=44) | cashflow | 全部历史，实时更新 | 2000起 | ✅（cashflow） |
| [业绩预告](https://tushare.pro/document/2?doc_id=45) | forecast | 全部历史，实时更新 | 2000起 | ✅（forecast） |
| [业绩快报](https://tushare.pro/document/2?doc_id=46) | express | 全部历史，实时更新 | 2000起 | ✅（express） |
| [分红送股](https://tushare.pro/document/2?doc_id=103) | dividend | 全部历史，实时更新 | 2000起 | ✅（dividend） |
| [财务指标数据](https://tushare.pro/document/2?doc_id=79) | fina_indicator | 全部历史，随财报实时更新 | 2000起 | ✅（fina_indicator） |
...
| [指数日线行情](https://tushare.pro/document/2?doc_id=95) | index_daily | 全部历史，交易日15点～17点更新 | 2000起 | ✅（index_daily） |
...
| [指数成分和权重](https://tushare.pro/document/2?doc_id=96) | index_weight | 月度成分和权重数据 | 2000 | ✅（index_weight） |
| [大盘指数每日指标](https://tushare.pro/document/2?doc_id=128) | index_dailybasic | 数据开始月2004年1月，每日盘后更新 | 4000起 | ❌ |
| [申万行业分类](https://tushare.pro/document/2?doc_id=181) | index_classify | 全部分类 | 2000 | ✅（sw_industry） |
...
| [公募基金持仓数据](https://tushare.pro/document/2?doc_id=121) | fund_portfolio | 股票持仓数据，定期采集更新 | 5000起 | ❌ |
...
| [期货交易日历](https://tushare.pro/document/2?doc_id=137) | trade_cal | 数据开始月1996年1月，定期更新 | 2000 | ❌（股票用 trade_cal） |
...
- 本项目已对接接口清单 → [03-tushare-interface-summary.md](./03-tushare-interface-summary.md)
- 新接口对接步骤 → [02-tushare-integration-guide.md](./02-tushare-integration-guide.md)
- 数据管控中心 → [05-data-governance-center.md](./05-data-governance-center.md)
