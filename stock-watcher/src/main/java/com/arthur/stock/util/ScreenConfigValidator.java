 ...
 * 校验失败统一抛 {@link BusinessException}({@link ErrorCode#SCREEN_CONFIG_INVALID})，
 * 错误信息带 JSON path，便于定位。
 *
 * @see ErrorCode#SCREEN_CONFIG_INVALID
 */
public final class ScreenConfigValidator {
     ...
     * @throws BusinessException 配置非法时抛出，code = {@link ErrorCode#SCREEN_CONFIG_INVALID}
     */
